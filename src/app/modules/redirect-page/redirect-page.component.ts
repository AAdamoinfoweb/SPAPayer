...
export class RedirectPageComponent implements OnInit {
  ...
  redirectCarrello() {
    ...
    const bufferS = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
      "<Buffer><ProtocolVersion>0</ProtocolVersion><CodicePortale>CCC</CodicePortale><TagOrario>202005130008</TagOrario><BufferDati>NjE2Yzg2ZGQtNjIwNS00YmM4LTk5YzUtZDRlMTdiZjc2NzRi</BufferDati><Hash>b9f6b1e42be273183347f233dec18c95</Hash></Buffer>"
